        ...
        <div className="border-b border-gray-200 pb-6 mb-10 text-left flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="bg-gray-50 border border-gray-200 p-3 flex items-center gap-3.5">
            ...
            <div className="text-left">
              ...
              <p className="text-[10px] text-gray-500 font-mono tracking-wide leading-none uppercase mt-0.5">{user.email}</p>
            </div>
          </div>
        </div>
        ...
        {(user.role === 'all') && !activeWorkspace && (
          <div className="text-left">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-[11px] font-mono text-gray-500 uppercase tracking-wider font-bold">Select your active workspace</span>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {workspaceOptions.map((ws) => (
                ...
                >
                  ...
                  <p className="text-[11px] text-gray-500 font-sans mt-1.5 leading-relaxed">{ws.desc}</p>
                </button>
              ))}
            </div>
          </div>
            ...
            <div className="border-b border-gray-200 pb-4 mb-8 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="text-[10px] font-mono text-gray-500 hover:text-gray-900 border border-gray-200 px-2.5 py-1 outline-none"
                >
                  ← Switch Workspace
                </button>
                <span className="text-[13px] font-bold uppercase tracking-wider text-[#3373AB]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-left">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="border border-gray-200 bg-white p-5 relative overflow-hidden">
                <div className="absolute top-0 right-0 p-3 text-[10px] font-mono text-[#3373AB] font-bold">
                  TRACKING: NX-9812A
                </div>
                
                <h4 className="font-sans font-bold text-sm text-gray-900 uppercase tracking-tight">IoT Gateway Core Hub X1</h4>
                <p className="text-[10px] font-mono text-gray-500">VENDOR HUB: Nexus Embedded Corp • CALIBRATED: Yes</p>
                
                <div className="mt-4 grid grid-cols-4 gap-2 text-center text-[10px] font-mono select-none">
              ...
              <div className="border border-gray-200 bg-white">
                <div className="bg-gray-100 p-3 border-b border-gray-200 font-mono text-[10.5px] uppercase font-bold tracking-wider text-gray-500">
                ...
                <div className="divide-y divide-gray-100">
                  <div className="p-4 flex justify-between items-center text-xs">
                    <div>
                      ...
                      <span className="text-[10px] text-gray-500 font-mono">Invoice hash: #IN-44281X • May 14, 2026</span>
                    </div>
                  ...
                  <div className="p-4 flex justify-between items-center text-xs">
                    <div>
                      ...
                      <span className="text-[10px] text-gray-500 font-mono">Invoice hash: #IN-31012Y • Mar 10, 2026</span>
                    </div>
            ...
            <div className="lg:col-span-4 bg-gray-100 border border-gray-200 p-6 space-y-6">
              ...
              <div className="bg-gray-50 p-4 border border-gray-100 font-mono text-[11px] text-gray-500 uppercase">
        ...
        {(user.role === 'student' || activeWorkspace === 'student') && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-left">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="border border-gray-200 bg-white p-5 text-left flex flex-col justify-between h-[160px]">
                  <div>
                    <span className="text-emerald-400 font-mono text-[9px] font-bold uppercase tracking-wider block mb-1">✓ PASSED ACCREDITED EXAM</span>
                    <h4 className="font-sans font-bold text-xs text-gray-900 uppercase tracking-tight">Advanced Embedded Systems</h4>
                  </div>
                  <div className="border-t border-gray-100 pt-3 mt-4 flex justify-between items-center text-[10px] font-mono text-gray-500">
                    <span>SCORE: 100%</span>
                ...
                <div className="border border-[#3373AB]/50 bg-white p-5 text-left flex flex-col justify-between h-[160px]">
                  <div>
                    <span className="text-[#3373AB] font-mono text-[9px] font-bold uppercase tracking-wider block mb-1">▶ CURRENT SYLLABUS TRACK</span>
              ...
              <div className="border border-gray-200 bg-white p-5">
                <span className="text-amber-400 font-mono text-[9px] font-bold block mb-1">CONNECTIVITY OVERRIDE</span>
            ...
            <div className="lg:col-span-4 bg-gray-100 border border-gray-200 p-6 space-y-6">
              ...
              <ul className="space-y-4 font-mono text-[10.5px] text-gray-500">
        ...
        {(user.role === 'instructor' || activeWorkspace === 'instructor') && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-left">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              {/* Live listings */}
              <div className="border border-gray-200 bg-white">
                <div className="bg-gray-100 p-3 border-b border-gray-200 font-mono text-[10px] uppercase text-gray-500 block font-bold tracking-wider">
                  ...
                  {instructorBroadcasts.map((b) => (
                    <div key={b.id} className="p-4 flex justify-between items-center">
                      <div>
                        ...
                        <span className="text-[10px] text-gray-500 font-mono">{b.category} • Host: {b.host}s</span>
                      </div>
                      <span className="text-[10px] bg-gray-200 border border-gray-300 text-gray-600 px-1.5 font-mono">views: {b.views}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        {(user.role === 'vendor' || activeWorkspace === 'vendor') && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-left">
                  ...
                  {vendorProducts.map((p) => (
                    <div key={p.id} className="p-4 flex justify-between items-center">
                      <div>
                        ...
                        <span className="text-[10px] text-gray-500 font-mono">{p.category} • Original Equiper: {p.vendorName}</span>
                      </div>
            ...
            <div className="lg:col-span-4 bg-gray-100 border border-gray-200 p-6 space-y-6">
              ...
              <div className="bg-gray-50 p-4 border border-gray-100 space-y-3 font-mono text-[11px] text-gray-500 uppercase">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-left">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="border border-gray-200 bg-white p-5 text-left relative overflow-hidden">
                <span className="text-[#3373AB] font-mono text-[9px] font-bold block mb-1">CAMPAIGN: NX-BANNER-442</span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4 font-mono text-xs">
                  <div className="border-l border-gray-300 pl-3">
                    <span className="text-[10px] text-gray-500 block uppercase">Estimated Impressions</span>
                    <span className="text-lg font-bold text-gray-900 mt-1 block">50,000</span>
                  </div>
                  
                  <div className="border-l border-gray-300 pl-3">
                    <span className="text-[10px] text-gray-500 block uppercase">Realized views (Logs)</span>
                    <span className="text-lg font-bold text-emerald-400 mt-1 block">51,210</span>
                  </div>

                  <div className="border-l border-gray-300 pl-3">
                    <span className="text-[10px] text-gray-500 block uppercase">Realized clicks conversion</span>
              ...
              <div className="border border-gray-200 bg-white p-5">
                <span className="text-[#3373AB] font-mono text-[9px] font-bold block mb-1">LIVE OPTIMIZATION ENGINE</span>
                ...
                <div className="mt-4 flex gap-4">
                  <span className="text-[11px] font-mono text-gray-500">Active allocation: RWF 2,500 Monthly • CTR Index: Vetted Q1</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-4 bg-gray-100 border border-gray-200 p-6 space-y-6">
              ...
              <div className="bg-gray-50 p-4 border border-gray-100 space-y-2 font-mono text-[10.5px] text-gray-500 uppercase">
                <span className="flex justify-between">
