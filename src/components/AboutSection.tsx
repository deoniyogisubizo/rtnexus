    ...
    <section className={`w-full select-none py-12 px-6 font-sans ${isDark ? 'bg-[#1a1a1a] text-gray-200' : 'bg-white text-gray-900'}`}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border-l-4 border-[#3373AB] pl-5 mb-10 text-left">
          ...
          <h2 className={`text-xl lg:text-2xl font-bold uppercase tracking-tight mt-1 text-left ${isDark ? 'text-white' : ''}`}>RT NEXUS CORPORATE PHILOSOPHY & LEADERSHIP</h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-gray-50 border border-gray-200 p-8 mb-12 text-left">
          ...
          <div className="lg:col-span-4 flex flex-col gap-3 font-mono">
            <div className="bg-[#3373AB] text-white p-4 font-mono font-bold uppercase tracking-wider">
              <span className="text-[10px] text-gray-100 block tracking-widest font-normal">Sovereignty Target</span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
              <div className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-500 mt-1">Accelerate silicon telemetry and guarantee the supply-chain ledger securely.</p>
                </div>
              </div>
              ...
              <div className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-500 mt-1">Every component unit undergoes dynamic physical testing before freight courier logging.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            {leadership.map((member, index) => (
              <div key={index} className="border border-gray-200">
                <div className="h-48 bg-gray-100 overflow-hidden relative">
                  ...
                  />
                  <span className="absolute top-2 left-2 bg-[#111111] text-white font-mono text-[9px] px-2 py-0.5 uppercase font-bold tracking-wider">
                    DEAN_DIR
                  </span>
                </div>
                ...
                <div className="p-4 bg-white">
                  ...
                  <p className="text-[10px] font-mono text-[#3373AB] uppercase font-bold mt-0.5">{member.role}</p>
                  <p className="text-[11px] text-gray-500 font-light mt-3 leading-relaxed border-t border-gray-100 pt-3">
                    {member.bio}
                  </p>
                </div>
              </div>
